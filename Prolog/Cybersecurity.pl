...
course(cc120l, 'Application of Information & Communication Technologies Lab', 1, [cc120]).
course(cc111, 'Programming Fundamentals', 3, []).
course(cc111l, 'Programming Fundamentals Lab', 1, [cc111]).
...
course(ns125l, 'Applied Physics Lab', 1, [ns125]).
...
course(cc121l, 'Digital Logic Design Lab', 1, [cc121]).
...
course(cc230l, 'Database Systems Lab', 1, [cc230]).
...
course(cy261l, 'Information Assurance Lab', 1, [cy261]).
course(cc251, 'Computer Networks', 2, []).
course(cc251l, 'Computer Networks Lab', 1, [cc251]).

% Semester 5
course(cy361, 'Cyber Security', 2, [cc361]).
course(cy361l, 'Cyber Security Lab', 1, [cy361]).
course(cc323, 'Operating Systems', 3, []).
course(cc323l, 'Operating Systems Lab', 1, [cc323]).
...
% Semester 6
course(cy391, 'Secure Software Design and Development', 2, [cy361]).
course(cy391l, 'Secure Software Design and Development Lab', 1, [cy361, cy361l]).
course(cy351, 'Network Security', 3, [cy361]).
...
% Semester 7
course(cy461, 'Digital Forensics', 3, [cy361]).
